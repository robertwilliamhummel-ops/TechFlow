...
export const metadata: Metadata = {
  ...
  description: 'Custom business automation tools for Toronto companies. Invoicing systems, workflow automation, payment processing, and client portals built by 15+ year IT engineers.',
...
const solutions = [
  { icon: 'fa-file-invoice-dollar', title: 'InvoicePro: Mobile-First Invoicing',  desc: 'A complete invoicing solution purpose-built for field service businesses.', features: ['Mobile-first invoice creation','Automated payment reminders','Client management portal','Financial reporting dashboard','Stripe payment integration'] },
