...
const solutions = [
  { icon: 'fa-file-invoice-dollar', title: 'InvoicePro: Mobile-First Invoicing',  desc: 'A complete invoicing solution purpose-built for field service businesses. Built on React, Firebase, Stripe, and Cloud Run — the same stack powering our InvoicePro product.', features: ['Mobile-first invoice creation','Automated payment reminders','Client management portal','Financial reporting dashboard','Stripe payment integration'] },
